        ...
        if (!profileData.addresses || profileData.addresses.length === 0) {
            return `
                <div class="col-12 text-center py-5">
                    <i class="fas fa-home fa-3x mb-3 text-muted address-empty-icon"></i>
                    <p class="text-muted address-empty-text">Henüz kayıtlı adresiniz bulunmuyor.</p>
                </div>
            `;
        }
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th><i class="fa-solid fa-turkish-lira-sign"></i>Tutar</th>
            ...
            return `
                <tr>
                    <td colspan="5" class="text-center py-4">
                        <i class="fas fa-box-open fa-3x mb-3 text-muted orders-empty-icon"></i>
                        <p class="text-muted orders-empty-text">Henüz siparişiniz bulunmuyor.</p>
                    </td>
                </tr>
            `;
        }
